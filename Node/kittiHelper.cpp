...
int main(int argc, char** argv)
{
    ...
    std::string ground_truth_path = sequence_number + "/" + sequence_number + ".txt";
    ...
    while (std::getline(timestamp_file, line) && ros::ok())
    {
        ...
        right_image_path << dataset_folder << sequence_number + "/image_1/" << std::setfill('0') << std::setw(6) << line_num << ".png";
