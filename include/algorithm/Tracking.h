...
public:
    ...
    cv::Mat GrabImageFusion(const cv::Mat &im,
...
public:
    ...
    // Input sensor:MONOCULAR, STEREO, RGBD, Fusion
    ///传感器类型
    int mSensor;
...
protected:
   ...
   /**
    ...
    PointICloudPtr local_lidarmap_cloud_ptr_;
    pcl::KdTreeFLANN<PointI>::Ptr kdtree_local_map_;
//    pcl::VoxelGrid<pcl::PointXYZI> down_size_filter;
    ...
    //Motion Model  mVelocity = Tcl = Tcw * Twl,表示上一帧到当前帧的变换
    cv::Mat mVelocity;
